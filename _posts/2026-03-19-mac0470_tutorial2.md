...
O segundo comando é a transferencia de um arquivo, no entanto ele não funcionou para mim. Então para isso fiz uma pequena alteração na ordem dos comandos:
