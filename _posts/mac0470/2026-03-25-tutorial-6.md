---
title: Tutorial 6
permalink: /mac0470/tutorial-6/
tags: [linux, softaware livre, VM]
---

O sexto tutorial foi sobre [**Sending patches with git and a USP email**](https://flusp.ime.usp.br/git/sending-patches-with-git-and-a-usp-email/). A seguir, os erros encontrados durante o processo.

## Testing the setup with kw send-patch

### Mecanismo SASL Não Encontrado 
